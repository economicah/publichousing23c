...
<br><br><br>
It is interesting that we found a relationship between "poverty area" and "months waiting"" when we performed a chi square test on the categories of "months waiting", but that a relationship does not seem to exist when we test the means for the continuous months_waiting variable. 
